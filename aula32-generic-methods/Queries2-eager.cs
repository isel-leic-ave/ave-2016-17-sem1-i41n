            ...
            Convert(
                Filter(
                    Filter(
                        ...
                        s => { Console.WriteLine("Filtering"); return ((Student) s).nr > 38000; }), 
                    s => { Console.WriteLine("Filtering"); return ((Student) s).name.StartsWith("A"); }),
                s => { Console.WriteLine("Converting"); return ((Student) s).name; }
            );
